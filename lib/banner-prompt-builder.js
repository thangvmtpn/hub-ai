 ...
 */
export function buildBannerPrompt(data = {}) {
  const {
    product_line = '',
  ...
  const subjectSection = visual_elements
    ? `Main Subject & Background: ${visual_elements}.`
    : 'Main Subject: Premium Vietnamese tea experience, elegant arrangement of tea product.';
  ...
  const colorSection = (primary_color || secondary_color)
    ...
    : 'Color Palette: Natural tea green, warm golden amber accents, clean commercial color grading.';
