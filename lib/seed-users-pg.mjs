...
async function main() {
  ...
  const users = [
    { username: 'admin', password: '123', name: 'Admin', role: 'admin', department: 'all', position: 'Admin', allowed_agents: [] },
    { username: 'ke_toan', password: '123', name: 'Kế Toán', role: 'user', department: 'finance', position: 'Kế Toán', allowed_agents: ['fin_workflow_designer'] },
  ];
